...
![image](https://user-images.githubusercontent.com/52172169/149618577-ef2eb65c-079a-490c-b23d-e01d4a4c6f02.png)
...
1. 경로 길이를 저장할 배열 distance 준비 => 시작 정점으로부터 각 정점에 이르는 경로의 길이를 저장하기 위한 배열 distance를 INF로 초기화
