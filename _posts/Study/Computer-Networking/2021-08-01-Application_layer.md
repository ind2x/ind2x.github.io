...
그리고 상당한 서버 기반구조와 서버 대역폭을 요구하지 않기 때문에 (데이터센터의 **```클라이언트-서버```** 구조와는 대조적으로) 비용이 효율적임.
...
![image](https://user-images.githubusercontent.com/52172169/167245076-72abbf21-fdb6-40cd-8af1-08af8c8c4912.png)
