...
![image](https://user-images.githubusercontent.com/52172169/178440210-fec7a695-85d5-4aa9-9d9d-415bc3400a2b.png)

<br>

위의 사진이 직관적으로 보여준다.

결론만 말하면 손실이 발생하지 않으면 윈도우를 증가시키고, 손실이 발생하면 윈도우를 감소시키는걸 발복하게 되는데, 두 연결에 의해 실현되는 대역폭이 똑같은 대역폭 공유선을 따라서 결국에는 변동하고 수렴하게 된다는 것이다.
