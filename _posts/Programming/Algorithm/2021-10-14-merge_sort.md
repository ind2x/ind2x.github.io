...
## 참고
Link : <a href="https://www.daleseo.com/sort-merge/" target="_blank">https://www.daleseo.com/sort-merge/</a>  
Link : <a href="https://gmlwjd9405.github.io/2018/05/08/algorithm-merge-sort.html" target="_blank">https://gmlwjd9405.github.io/2018/05/08/algorithm-merge-sort.html</a>   

## Merge Sort
<img src="https://blog.kakaocdn.net/dn/b41mz2/btqvJJ3l2OA/W4Y9ZhPcnnhpMnkQnGkuH0/img.gif" style="padding-left: 120px;">  

**구체적인 개념을 설명하면 다음과 같음.**  
```
하나의 리스트를 두 개의 균등한 크기로 분할하고 분할된 부분 리스트를 정렬한 다음, 
두 개의 정렬된 부분 리스트를 합하여 전체가 정렬된 리스트가 되게 하는 방법임.
```
...
부분 배열을 정렬함. 
부분 배열의 크기가 충분히 작지 않으면 순환 호출을 이용하여 
다시 분할 정복 방법을 적용함.
```
```
3. 결합(Combine)
...
단점은 정렬된 데이터 배열을 담을 새로운 배열이 필요하여
추가적인 메모리가 사용된다는 점임.
```
