...
## 참고
Link : <a href="https://choseongho93.tistory.com/130" target="_blank">choseongho93.tistory.com/130</a>  
Link : <a href="https://kimdoky.github.io/tech/2017/05/06/regular/" target="_blank">kimdoky.github.io/tech/2017/05/06/regular/</a>  
Link : <a href="https://hamait.tistory.com/342" target="_blank">hamait.tistory.com/342</a>  
...
공백은 ' ' 을 뜻하는 문자이고 빈 문자열은 ""을 뜻하는 것임.
따라서 답은 /^$/
```
...
```
```
처음 제출한 답은 /^wechall4?\.(jpg|gif|tiff|bmp|png)$/
하지만 non-capturing group을 사용하라 뜸.

Your pattern would capture a string, but this is not wanted. 
