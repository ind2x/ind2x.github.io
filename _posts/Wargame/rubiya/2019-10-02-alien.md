...
sandbox2
```
걍 풀이 봄. <a href="https://blog.limelee.xyz/entry/LOS-alien?category=711778" target="_blank">https://blog.limelee.xyz/entry/LOS-alien?category=711778</a>
```
...
```
```
phpmyadmin으로 할 때와 wsl로 mysql 접속해서 하는게 결과가 다름.. 
wsl로 접속해서 하는 법 익혀두기..
```