...
tags: [php 배열 요소의 접근, 중괄호, php 복합 문법, php curly, php 변수 출력, php type casting, php object to array, php fast object to array conversion, php curly brace, 중괄호, php echo, php finfo, php 중괄호를 이용한 변수 해석, php curly braces in array since php 7, 문자열 및 echo 출력]
---
